...
public class CurrencyConversion {
    ...
    public CurrencyConversion(long id, String from, String to, BigDecimal conversionMultiple, BigDecimal quantity, BigDecimal totalCalculatedAmt, String environment) {
        this.id = id;
        this.from = from;
        this.to = to;
